 ...
 * @author xiaohe
 */
public class CurDateUtils {

    private CurDateUtils() {
    }
    ...
    public static long strConvertToLong(String time, String pattern) {
        // DateTimeFormatter.ISO_DATE_TIME
        return dateConvertToMillis(LocalDateTime.parse(time, DateTimeFormatter.ofPattern(pattern)));
    }

    public static String millisConvertToStr(long millis, String pattern) {
        // DateTimeFormatter.ISO_DATE_TIME
        return dateConvertToStr(millisConvertToDate(millis), pattern);
    }
